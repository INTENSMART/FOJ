...
urlpatterns = [
    ...
    #path('administrateur/profil/edit',auth_view..as_view(template_name='dashboard/editProfilAdmin.html'),name='editProfilAdmin'),
    ...
    path('etablissement/vue/<int:cle>',views.listEtablissement,name='listEtablissement'),
